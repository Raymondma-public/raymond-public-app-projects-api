...
public class ProjectsContoller {
	...
	public Project getProject(@PathVariable(value = "projectId" ) Optional<Long> projectId) {
		Optional<Project> projOpt=projectService.getProjects(projectId.orElse(1l));
		if(projOpt.isPresent()){
			return projOpt.get();
		}else{
			throw new IllegalArgumentException(projectId + " Not exist");
		}
	}
